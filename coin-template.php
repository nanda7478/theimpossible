...
$title_vari = $product_variation->get_title();
$link = $product_variation->get_permalink();*/
?>
<?php //} ?>
<?php
/*$sizes = get_the_terms($parent_id ,'pa_color');*/
?>
...
<script type="text/javascript">
  ...
  var address = "http://theimpossibleco.com/coin/?alltype=" + valv;
...
<script type="text/javascript">
    ...
    $("#artistname").change(function () {
     ...
     var address = "http://theimpossibleco.com/?alltype=" + alltypeartist + "&allatrist=" + artistname ;
      window.location.replace(address);
 ...
 <script type="text/javascript">
    ...
    $("#artistname").change(function () {
        var alltypeartist = $("#alltypeartist").val();
        var artistname = $("#artistname").val();
     var address = "http://theimpossibleco.com/coin/?alltype=" + alltypeartist + "&allatrist=" + artistname ;
      window.location.replace(address);
     });
  });
 ...
 <script type="text/javascript">
    ...
    $("#orderby").change(function () {
     ...
     var address = "http://theimpossibleco.com/coin/?orderby=" + orderby;
      window.location.replace(address);
     });
  });
